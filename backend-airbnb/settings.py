"""
Django settings for backend-airbnb project.
...
ROOT_URLCONF = 'backend-airbnb.urls'
...
WSGI_APPLICATION = 'backend-airbnb.wsgi.application'

ASGI_APPLICATION = 'backend-airbnb.asgi.application'
