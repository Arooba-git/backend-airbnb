...
def properties_list(request):
    ...
    if (checkin_date and checkout_date):
        ...
        overlapping_matches = Reservation.objects.filter(start_date__lte=checkout_date) | Reservation.objects.filter(end_date__gte=checkin_date)
        all_matches = []

        for reservation in exact_matches |  overlapping_matches:
